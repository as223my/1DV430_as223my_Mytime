    ...
    <body>
    	...
    	<div id="container">
	        ...
	        <header>
	       	...
	       	<form action = 'Juli.php' method="post"><input type="submit" name="logout" id="Logout" class = "buttonRed" value="Logga ut"></form>
	       	<a href="Gallery.php" id="galleryA"> <button id = "gallerybutton" class ="buttonToGallery">Bilder</button></a>
	       	
	        <a href="Augusti.php" class="right">></a>
	        <a href="Juni.php" class="left">&lt</a>
