    ...
    <body>
    	...
    	<div id="container">
	        ...
	        <header>
	       	...
	       	<form action = 'April.php' method="post"><input type="submit" name="logout" id="Logout" class = "buttonRed" value="Logga ut"></form>
	       	<a href="Gallery.php" id="galleryA"> <button id = "gallerybutton" class ="buttonToGallery">Bilder</button></a>
	       	
	        <a href="Maj.php" class="right">></a>
	        <a href="Mars.php" class="left">&lt</a>
