    ...
    <body>
    	...
    	<div id="container">
	        ...
	        <header>
	       	...
	       	<form action = 'September.php' method="post"><input type="submit" name="logout" id="Logout" class = "buttonRed" value="Logga ut"></form>
	       	<a href="Gallery.php" id="galleryA"> <button id = "gallerybutton" class ="buttonToGallery">Bilder</button></a>
	       	
	        <a href="Oktober.php" class="right">></a>
	        <a href="Augusti.php" class="left">&lt</a>
